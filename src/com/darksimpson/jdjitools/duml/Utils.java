...
public class Utils {
	private static final int[] djiCrc8Table = {
	...
	public static int calcDjiCrc8(byte[] data, int length)
	{
		int tmpCrc = DJI_CRC8_INIT;

		for (int i = 0; i < length; i++) {
			tmpCrc = djiCrc8Table[tmpCrc ^ data[i]];
		}
	...
	public static int calcDjiCrc16(byte[] data, int length)
	{
		...
		for (int i = 0; i < length; i++) {
			tmpCrc = (tmpCrc >> 8) ^ djiCrc16Table[(tmpCrc ^ data[i]) & 0xFF];
		}
